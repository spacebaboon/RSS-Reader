                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: feedInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" value="${feedInstance?.name}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: feedInstance, field: 'url', 'errors')}">
                                    <g:textField name="url" value="${feedInstance?.url}" />
                                </td>
                            </tr>
